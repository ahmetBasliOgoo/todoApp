$('.container__input').on('keyup', function(e){
    ...
    if(e.keyCode==13 && $('.container__input').val()!==''){
        ...
        const trash = $('<i class="container__task__icon  fas fa-trash-alt"></i>').on('click', function(e){
            task.remove()
        })
        const check = $('<i class="container__task__icon fas fa-check"></i>').on('click', function(e){
